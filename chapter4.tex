...
A quick comparison between Eqs. \ref{eq:hxspect} and \ref{eq:hxpsi2} allows to build an equivalence table between the generating function coefficients and the spectral lines. This table can be originally found in Refs. \cite{sussix,bartolini}.
