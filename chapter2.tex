...
The whole point of introducing the Normal Form coordinates ($J_u,\phi_u$) through the transformation $e^{-:F:}$ as defined in Eq. \ref{eq:F} is to get simple dynamics that lie on a circle. When this happens, a set of canonical coordinates can be defined as:
